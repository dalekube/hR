...
#' @title hierarchyLong
#' @description This function transforms a standard set of 
#' employee and supervisor identifiers into a long format representing
#' full hierarchies. This is especially useful for narrowing in on a 
