...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-110480958-3"></script>
<script>
...
The examples in this document leverage the sample `workforceHistory` data set which reflects an artificial organization's workforce history data. The sample is reduced to a data.table that contains one row per active employee and contractor in order to properly use the `hierarchyLong` and `hierarchyWide` functions.
