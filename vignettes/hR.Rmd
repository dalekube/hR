...
The `hR` package serves as a toolkit for data analysts, data scientists, and other analytics practitioners who address workforce-related problems. The goal of the package is to provide functions for manipulating, analyzing, and visualizing workforce data in meaningful ways. This vignette excludes the `workforcePlan` app which is available for simple workforce planning.  
